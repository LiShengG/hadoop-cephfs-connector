...
E3 已完成真实三节点 Hadoop/YARN、MR 提交/推测、DistCp、Hive 4 MR/Tez 基础矩阵和 Spark
...
- 当前 E3：同三节点部署 Hadoop 3.3.6 + Hive 4.0.1 + Tez 0.10.4 + Spark 3.4.4；HDFS 3 DataNode、YARN 3
  ...
  ANALYZE 与 TRUNCATE 在 MR/Tez 双引擎通过；Spark 三节点 checkpoint 从 batch 0/40 行推进到失败后恢复的
